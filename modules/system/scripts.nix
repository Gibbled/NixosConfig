{
  ...
  change-wallpaper = pkgs.writeShellScriptBin "change-wallpaper" ''
    ...
    ${pkgs.awww}/bin/awww img --transition-type random --transition-step 10  --transition-duration 10 --transition-bezier 0.0,0.0,1.0,1.0 "`${pkgs.findutils}/bin/find /home/ranjit/Downloads/Wallpaper-Bank/ -type f -print|${pkgs.coreutils-full}/bin/shuf -n 1`"
    #${pkgs.waypaper}/bin/waypaper --backend awww --random
  '';
